...
import bsu.rfe.course2.group6.kupriyanov.GornerTableCellRenderer;
import bsu.rfe.course2.group6.kupriyanov.GornerTableModel;
    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action aboutInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Куприянов Тимофей, 6 группа", "О программе",
